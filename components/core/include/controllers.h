...
#define ATTITUDE_KP             5.0          
#define ATTITUDE_KI             3.0           
#define ATTITUDE_KD             0.0
#define ATTITUDE_LIMIT          2*M_PI

#define ATTITUDE_RATE_KP        45.0       
#define ATTITUDE_RATE_KI        20.0        // 50.0      
...
#define ALTITUDE_RATE_KP        70.0    
#define ALTITUDE_RATE_KI        100.0   
